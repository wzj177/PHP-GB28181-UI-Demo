<template>
  <div class="error">
    <div class="error-flex">
      <div class="left">
        <div class="left-item">
          <div class="left-item-animation left-item-num">500</div>
          <div class="left-item-animation left-item-title">
            {{ $t('message.serverInternalError.title') }}
          </div>
          <div class="left-item-animation left-item-msg">
            {{ $t('message.serverInternalError.msg') }}
          </div>
          <div class="left-item-animation left-item-btn">
            <el-button type="primary" round @click="onGoHome">{{
              $t('message.serverInternalError.btn')
            }}</el-button>
          </div>
        </div>
      </div>
